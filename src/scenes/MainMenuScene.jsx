  ...
  return (
    <div className="h-full flex flex-col bg-zinc-950 relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 relative z-10">
        ...
        <div className="glass-panel backdrop-blur-md animate-boss-breathe w-full max-w-sm rounded-2xl p-6 border border-cyan-500/30 bg-zinc-950/60">

          {/* ── Title Block ── */}
          <div className="mb-8 text-center">
            <p className="font-mono text-[10px] uppercase tracking-widest text-cyan-400/40 mb-3">
